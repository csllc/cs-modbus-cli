...
The `mb` utility provided by this package is known to work with NodeJS versions 10.22.1 and 12.18.3. Newer verions may or may not work due to package dependencies, and older versions may work without support for native CAN adapters (PCAN, Kvaser).
